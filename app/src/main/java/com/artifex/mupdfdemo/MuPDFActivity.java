...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport {
        ...
        mAlertTask = new AsyncTask<Void, Void, MuPDFAlert>() {
            ...
            protected void onPostExecute(final MuPDFAlert result) {
                ...
                switch (result.buttonGroupType) {
                    ...
                    case Ok:
                        mAlertDialog
                                .setButton(AlertDialog.BUTTON1, getString(R.string.okay), listener);
                    ...
                    case YesNo:
                        mAlertDialog
                                .setButton(AlertDialog.BUTTON1, getString(R.string.yes), listener);
                        pressed[0] = MuPDFAlert.ButtonPressed.Yes;
                        mAlertDialog
                                .setButton(AlertDialog.BUTTON2, getString(R.string.no), listener);
                ...
                if (uri.toString().startsWith("content://")) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            System.out.println(
                                    "Exception in Transformer Prime file manager code: " + e2);
                            reason = e2.toString();
                        }
                    }
                    if (reason != null) {
    ...
    public void createUI(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null || !savedInstanceState
                .getBoolean("ButtonsHidden", false)) {
            showButtons();
        }
    ...
    private void showInfo(String message) {
        ...
        if (currentApiVersion >= android.os.Build.VERSION_CODES.HONEYCOMB) {
            SafeAnimatorInflater safe = new SafeAnimatorInflater((Activity) this, R.animator.info,
                    (View) mInfoView);
        } else {
